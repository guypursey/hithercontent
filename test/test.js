...
describe("Getting JSON from API", function() {
    describe("Requesting content without initialisation", function () {
    ...
    describe("Requesting content from an incorrect path", function () {
    ...
    describe("Requesting content from a correct path", function () {
